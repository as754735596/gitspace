...
-- ----------------------------
BEGIN;
INSERT INTO `sys_datasource_conf` VALUES ('3', 'missile', 'jdbc:mysql://missile-mysql:3306/missile?characterEncoding=utf8&zeroDateTimeBehavior=convertToNull&useSSL=false&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=GMT%2B8&allowMultiQueries=true', 'root', 'KWhhogQK2EsOICc9YFHTpQ==', '2019-03-31 16:40:43', '2019-04-11 20:57:06', '0', '1'), ('4', 'missile_ac', 'jdbc:mysql://missile-mysql:3306/missile_ac?characterEncoding=utf8&zeroDateTimeBehavior=convertToNull&useSSL=false&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=GMT%2B8', 'root', 'KWhhogQK2EsOICc9YFHTpQ==', '2019-03-31 17:53:25', '2019-04-11 20:57:28', '0', '1'), ('5', 'missile_job', 'jdbc:mysql://missile-mysql:3306/missile_job?characterEncoding=utf8&zeroDateTimeBehavior=convertToNull&useSSL=false&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=GMT%2B8', 'root', 'KWhhogQK2EsOICc9YFHTpQ==', '2019-03-31 17:53:25', '2019-04-11 20:57:54', '0', '1'), ('6', 'missile_zipkin', 'jdbc:mysql://missile-mysql:3306/missile_zipkin?characterEncoding=utf8&zeroDateTimeBehavior=convertToNull&useSSL=false&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=GMT%2B8', 'root', 'KWhhogQK2EsOICc9YFHTpQ==', '2019-03-31 17:53:25', '2019-04-11 20:57:57', '0', '1'), ('9', 'missile_config', 'jdbc:mysql://missile-mysql:3306/missile?characterEncoding=utf8&zeroDateTimeBehavior=convertToNull&useSSL=false&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=GMT%2B8', 'root', 'KWhhogQK2EsOICc9YFHTpQ==', '2019-03-31 19:56:12', '2019-04-11 20:58:16', '0', '1');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `sys_oauth_client_details` VALUES ('app', null, 'app', 'server', 'password,refresh_token', null, null, null, null, null, 'true', '1'), ('daemon', null, 'daemon', 'server', 'password,refresh_token', null, null, null, null, null, 'true', '1'), ('gen', null, 'gen', 'server', 'password,refresh_token', null, null, null, null, null, 'true', '1'), ('mp', null, 'mp', 'server', 'password,refresh_token', null, null, null, null, null, 'true', '1'), ('bingzo', null, 'bingzo', 'server', 'password,refresh_token,authorization_code,client_credentials', 'http://localhost:4040/sso1/login,http://localhost:4041/sso1/login', null, null, null, null, 'true', '1'), ('test', null, 'test', 'server', 'password,refresh_token', null, null, null, null, null, 'true', '1');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `sys_route_conf` VALUES ('1', '工作流管理模块', 'missile-activiti', '[{\"args\": {\"_genkey_0\": \"/act/**\"}, \"name\": \"Path\"}]', '[]', 'lb://missile-activiti', '0', '2019-05-09 00:23:08', '2019-05-18 15:16:23', '0'), ('2', '认证中心', 'missile-auth', '[{\"args\": {\"_genkey_0\": \"/auth/**\"}, \"name\": \"Path\"}]', '[{\"args\": {}, \"name\": \"ValidateCodeGatewayFilter\"}, {\"args\": {}, \"name\": \"PasswordDecoderFilter\"}]', 'lb://missile-auth', '0', '2019-05-09 00:23:08', '2019-05-18 15:16:25', '0'), ('3', '代码生成模块', 'missile-codegen', '[{\"args\": {\"_genkey_0\": \"/gen/**\"}, \"name\": \"Path\"}]', '[]', 'lb://missile-codegen', '0', '2019-05-09 00:23:08', '2019-05-18 15:16:28', '0'), ('4', 'elastic-job定时任务模块', 'missile-daemon-elastic-job', '[{\"args\": {\"_genkey_0\": \"/daemon/**\"}, \"name\": \"Path\"}]', '[]', 'lb://missile-daemon-elastic-job', '0', '2019-05-09 00:23:08', '2019-05-18 15:16:30', '0'), ('5', 'quartz定时任务模块', 'missile-daemon-quartz', '[{\"args\": {\"_genkey_0\": \"/job/**\"}, \"name\": \"Path\"}]', '[]', 'lb://missile-daemon-quartz', '0', '2019-05-09 00:23:08', '2019-05-18 15:16:33', '0'), ('6', '分布式事务模块', 'missile-tx-manager', '[{\"args\": {\"_genkey_0\": \"/tx/**\"}, \"name\": \"Path\"}]', '[]', 'lb://missile-tx-manager', '0', '2019-05-09 00:23:08', '2019-05-18 15:16:35', '0'), ('7', '通用权限模块', 'missile-upms-biz', '[{\"args\": {\"_genkey_0\": \"/admin/**\"}, \"name\": \"Path\"}]', '[{\"args\": {\"key-resolver\": \"#{@remoteAddrKeyResolver}\", \"redis-rate-limiter.burstCapacity\": \"20\", \"redis-rate-limiter.replenishRate\": \"10\"}, \"name\": \"RequestRateLimiter\"}, {\"args\": {\"name\": \"default\", \"fallbackUri\": \"forward:/fallback\"}, \"name\": \"Hystrix\"}]', 'lb://missile-upms-biz', '0', '2019-05-09 00:23:08', '2019-05-18 15:16:43', '0'), ('8', '工作流长链接支持1', 'missile-activiti-ws-1', '[{\"args\": {\"_genkey_0\": \"/act/ws/info/**\"}, \"name\": \"Path\"}]', '[]', 'lb://missile-activiti', '0', '2019-05-09 00:23:08', '2019-05-18 15:16:47', '0'), ('9', '工作流长链接支持2', 'missile-activiti-ws-2', '[{\"args\": {\"_genkey_0\": \"/act/ws/**\"}, \"name\": \"Path\"}]', '[]', 'lb:ws://missile-activiti', '100', '2019-05-09 00:23:08', '2019-05-18 15:16:49', '0'), ('10', '微信公众号管理', 'missile-mp-manager', '[{\"args\": {\"_genkey_0\": \"/mp/**\"}, \"name\": \"Path\"}]', '[]', 'lb://missile-mp-manager', '0', '2019-05-09 00:23:08', '2019-05-18 15:16:52', '0'), ('11', '监控管理', 'missile-monitor', '[{\"args\": {\"_genkey_0\": \"/monitor/**\"}, \"name\": \"Path\"}]', '[]', 'lb://missile-monitor', '0', '2019-05-09 00:23:08', '2019-05-18 15:16:55', '0');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `sys_user` VALUES ('1', 'admin', '$2a$10$QOfWxxFyAMmEEmnuw9UI/..1s4B4eF/u9PzE2ZaGO.ij9YfmcUy.u', '', '17034642889', 'bingzo-5b87318016954b6384e07ce10ba45030.jpg', '1', '2018-04-20 07:15:18', '2019-04-30 12:37:44', '0', '0', 'o_0FT0uyg_H1vVy2H0JpSwlVGhWQ', null, null, null, '1');
COMMIT;
